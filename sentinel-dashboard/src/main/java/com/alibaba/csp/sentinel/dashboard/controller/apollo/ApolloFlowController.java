...
/**
 * Flow rule controller for apollo.
 * rewrite {@link FlowControllerV1}
 * @author Eric Zhao
 * @since 1.4.0
 */
@RestController
@RequestMapping(value = "/v1/flow")
public class ApolloFlowController {

    private final Logger logger = LoggerFactory.getLogger(ApolloFlowController.class);
